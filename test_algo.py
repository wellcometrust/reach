...
from algo_tests.test_settings import settings
from algo_tests.test_scrape import test_scrape
from algo_tests.test_split_section import test_split_section
from algo_tests.test_parse import test_parse
from algo_tests.test_match_vectorised import test_match_vectorised
...
if __name__ == '__main__':
    ...
    test1_2_info, test1_score, test2_score = test_scrape(scrape_test_data)

    logger.info('[+] Running test 3')
    test3_info, test3_score = test_split_section(split_section_test_data)

    logger.info('[+] Running test 4')
    test4_info, test4_score = test_parse(parse_test_data, model)

    logger.info('[+] Running test 5')
    test5_info, test5_score = test_match_vectorised(match_publications, test_publications, settings.FUZZYMATCH_THRESHOLD)
